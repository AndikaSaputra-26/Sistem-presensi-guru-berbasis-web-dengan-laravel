    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card border-0 shadow">
                ...
                @endphp
                <div class="card-body">
                    <form action="{{ route('guru.absen.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating">Absen Masuk</label>
                                    <input type="time" name="absen_masuk" readonly value="{{ $dt->toTimeString() }}" required
                                        class="form-control @error('absen_masuk') is-invalid @enderror">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{  json_decode($setting->jam_masuk)[0] }} - {{ json_decode($setting->jam_masuk)[1] }}</td>
